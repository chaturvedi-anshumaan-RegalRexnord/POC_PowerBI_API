...
namespace AppOwnsData.Controllers
{
    ...
    public class EmbedInfoController : Controller
    {
        ...
        [HttpGet]
        public JsonResult GetTokenForReport(string workspaceid, string reportid)
        {
            var embedToken = pbiEmbedService.GetEmbedTokenForRDLReport(new Guid(workspaceid), new Guid(reportid));
            return Json(embedToken);
        }
    }
}
